...
const tools: HomeTool[] = [
  ...
  },
  {
    ...
    description: "Describe cron schedules in plain English + next run times",
    path: "/cron-parser",
    icon: Clock,
  },
  {
  ...
  },
  {
    ...
    description: "Convert between HEX, RGB, and HSL with a visual picker",
  ...
  },
  {
    ...
    description: "Count characters, words, lines, sentences, and byte size",
    path: "/char-counter",
    icon: AlignLeft,
  },
  {
  ...
  },
  {
    ...
    description: "Searchable list of HTTP status codes with descriptions",
    path: "/http-status",
    icon: Globe,
  },
  {
    name: "CIDR / Subnet Calculator",
    description: "Calculate network ranges, broadcast addresses, and host counts",
